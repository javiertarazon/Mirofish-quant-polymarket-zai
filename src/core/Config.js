...
const config = {
  ...
  swarm: {
    ...
    sportsWeight: numberFromEnv('SPORTS_AGENT_WEIGHT', 0.22, { min: 0, max: 1 }),
    topTraderWeight: numberFromEnv('TOP_TRADER_AGENT_WEIGHT', 0.18, { min: 0, max: 1 }),
    holderWeight: numberFromEnv('HOLDER_AGENT_WEIGHT', 0.18, { min: 0, max: 1 }),
    marketMoodWeight: numberFromEnv('MARKET_MOOD_AGENT_WEIGHT', 0.20, { min: 0, max: 1 }),
